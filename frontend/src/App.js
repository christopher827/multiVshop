...
<Route path="/sign-up" element={!isAuthenticated?<SignupPage />:<Navigate to="/profile"/>} />
...
{/* <Route path="/shop/:id" element={ isSeller?<ShopHomePage />:<Navigate to="/shop-login"/>}/> */}
...
<Route
        ...
        <Route
          path="/inbox"
          element={
            isAuthenticated? <UserInbox />
            :<Navigate to="/login"/>          }
        />
        <Route
          path="/user/order/:id"
          element={
            isAuthenticated?              <OrderDetailsPage />
              :<Navigate to="/login"/>            }
        />
        <Route
          path="/user/track/order/:id"
          element={
            isAuthenticated?              <TrackOrderPage />
            :<Navigate to="/login"/>            }
        />
